...
opt.showmode       = false   --- Don't showmode, it sucks
opt.showcmd        = false   --- Show commands
...
opt.termguicolors  = true    --- Only use real colors form now on. It's not 2005...
opt.ruler          = true    --- Enable the ruler
opt.list           = true    --- Enable lists
...
opt.rulerformat = "%30(%= \\:b%n%y%m%r%w\\ %l,%c%V\\ %P%)" --- Use a sane format
opt.completeopt = 'menuone,noinsert,noselect' --- Sane omnicomplete
